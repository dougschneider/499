...
public class AbstractAgent implements IAgent {
	...
	/**
	 * The algorithm which chooses the action among the liste of possible
	 * ones.xx
	 */
	protected ISelector algorithm;
	/**
	 * The universe in which the agent lives (to allow the referee to
	 * communicate with graphical interface)
	 */
	...
	/*
	 * TODO : It might be that this chosen action will not be the one finally
	 * performed (02/2007)
	 */
	...
	public void saveAgent() {
		...
		try {
			...
			System.err.println("Problem when trying to save agent "
					+ e.getMessage());
		}
